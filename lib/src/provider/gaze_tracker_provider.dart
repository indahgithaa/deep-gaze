...
import 'package:deep_gaze/src/model/app_stage.dart';
import 'package:deep_gaze/src/model/gazetracker_method_string.dart';

class GazeTrackerProvider with ChangeNotifier {
  dynamic state;
  static const licenseKey =
      'dev_qgebng8ilyumatpqi5mzqxdhx51ksbh3ugbiiga2'; // Please enter the key value for development issued by the SeeSo.io
